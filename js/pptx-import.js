...
(function () {
  ...
  var THEME_DEFAULTS = {
    'black-diamond': {
      logo: 'assets/logo-bd-white.svg',
      brandLine: 'Live. Climb. Repeat.'
    }
  };
  ...
  function buildSlide(templateId, extract, resizedImages, theme) {
    ...
    var brand = THEME_DEFAULTS[theme] || THEME_DEFAULTS['black-diamond'];
  ...
  /* -----------------------------------------------------------------------
     Main entry point. All imported slides land on the Black Diamond theme.
     ----------------------------------------------------------------------- */
  function parse(arrayBuffer /*, options */) {
    var theme = 'black-diamond';

...
(function () {
  ...
  /* -----------------------------------------------------------------------
     Theme defaults
     ----------------------------------------------------------------------- */
  var DEFAULT_LOGO = 'assets/logo-bd-white.svg';
  var DEFAULT_BRANDLINE = 'Live. Climb. Repeat.';
  function defaultLogoForTheme()      { return DEFAULT_LOGO; }
  function defaultBrandLineForTheme() { return DEFAULT_BRANDLINE; }
  ...
  function addSlide(templateId, theme) {
    var slide = {
      ...
      theme: theme || state.lastTheme || 'black-diamond',
  ...
  function applyImageEdit() {
    ...
    // isPng must also cover relative-path sources (e.g. "assets/logo-bd-white.svg"
  ...
  function openTemplateModal() {
    modalMode = 'add';
    modalSlideId = null;
    modalTheme = state.lastTheme || 'black-diamond';
    renderTemplateGrid();
  ...
  function openTemplateChangeModal(slideId) {
    ...
    modalTheme = slide.theme || state.lastTheme || 'black-diamond';
    renderTemplateGrid();
    openModal(dom.modalAddSlide);
  }
  ...
  function renderTemplateGrid() {
    ...
    // Theme is fixed to black-diamond — no picker shown.
  ...
  function loadState(newState) {
    ...
    state.theme = newState.theme || 'black-diamond';
  ...
  function init() {
    ...
    var pendingPptxTheme = 'black-diamond';
    ...
    document.getElementById('btn-load').addEventListener('click', function () {
      Dialog.choose('Load Presentation', 'Choose the file format to load:', [
        ...
        if (choice === 'json') {
          ...
          pendingPptxTheme = 'black-diamond';
    ...
    dom.fileInputLoad.addEventListener('change', function (e) {
      ...
      if (file.name.toLowerCase().endsWith('.pptx')) {
        ...
        var chosenTheme = dom._getPendingPptxTheme ? dom._getPendingPptxTheme() : 'black-diamond';

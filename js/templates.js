...
(function () {
  ...
  window.SlideTemplates = {
    ...
    title: {
      ...
      fields: [
        { key: 'title', role: 'title', type: 'text', label: 'Title', placeholder: 'e.g., Black Diamond Spring 2026 Range', required: true },
        { key: 'subtitle', role: 'subtitle', type: 'text', label: 'Subtitle', placeholder: 'e.g., Climbing, Skiing & Mountain Equipment' },
    ...
    generic: {
      ...
      fields: [
        { key: 'heading', role: 'title', type: 'text', label: 'Heading', placeholder: 'e.g., Why Choose Black Diamond?', required: true },
    ...
    gallery: {
      ...
      fields: [
        { key: 'heading', role: 'title', type: 'text', label: 'Heading', placeholder: 'e.g., Camalot C4 — Product Views', required: true },
    ...
    graph: {
      ...
      render: function (data) {
        ...
        if (mode === 'image') {
          ...
          // Black Diamond: burnt sienna accent
          var concreteAccent = '#B0532D';
